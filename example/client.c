...
{
  // Authentication provides all necessary credentials.
  ...
  if (taskd_sync (sync_key) == 0)
  {
    ...
    // to overwrite local tasks, or just be added to the list.  Simply query the
    // remote changes until the function retuns fails.
